...
import { ArrowRight, Brain, Activity, Utensils, Timer, ChevronDown, Instagram } from 'lucide-react';
...
export default function App() {
  return (
    <div className="min-h-screen bg-zinc-950 selection:bg-[#FF5A36]/30 selection:text-white">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="flex flex-col md:flex-row items-center gap-16">
            ...
            >
              ...
              <a 
                href="https://www.instagram.com/personalelise/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-zinc-900/80 backdrop-blur-md border border-white/10 text-white hover:bg-zinc-800 hover:border-white/20 transition-all duration-300 group"
              >
                <Instagram className="w-5 h-5 text-zinc-400 group-hover:text-[#FF5A36] transition-colors" />
                <span className="font-medium tracking-wide">@personalelise</span>
              </a>
            </motion.div>
      ...
      <a
        href="https://wa.me/554299646338?text=Ol%C3%A1%2C%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20o%20%22Protocolo%20F3%22"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-[#25D366] text-white rounded-full shadow-[0_4px_14px_0_rgba(37,211,102,0.39)] hover:scale-110 hover:shadow-[0_6px_20px_rgba(37,211,102,0.23)] transition-all duration-300"
